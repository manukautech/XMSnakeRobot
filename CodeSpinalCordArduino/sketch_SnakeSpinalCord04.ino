//SnakeSpinalCord - Version02 - change from ATtiny85 to Arduino Nano
#include <Servo.h>
...
//  The HC-05 TX connects to a single wire that runs the length of the robosnake
//  and is connected to pin RX of each Nano board.
//  Each board receives all signals and recognises the signals with its prefix and ignores the others.
//  Each Nano runs 8 servos on 4 segments using 5,6,7,8,9,10,11,12.
...
//  "A3-050"-- "Attention Nano 'A' - set servo number '3' to 'minus 50 percent".
//  "D0+000" -- "Attention Nano 'D' - set servo number '0' to 'mid' position".

//Config for this board
byte thisBoardId = 'A'; //Board A-D
